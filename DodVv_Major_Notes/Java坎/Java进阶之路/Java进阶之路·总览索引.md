...
> **来源**：[二哥的Java进阶之路](https://javabetter.cn) — 沉默王二的 Java 学习指南，风趣幽默、通俗易懂。
> 本笔记为网站内容的精华整理，配合课堂知识形成完整的学习体系。

---

## 🗺️ 知识库地图

本知识库覆盖 Java 学习的完整路径，从入门到进阶，从基础到面试，一应俱全。

```
Java基础 ───→ Java进阶 ───→ 数据库 ───→ 计算机基础 ───→ 求职面试
   │              │            │             │              │
   ├ 基础语法      ├ Spring     ├ MySQL       ├ 操作系统      ├ 八股文
   ├ 面向对象      ├ SpringBoot ├ Redis       ├ 计算机网络    ├ 面经
   ├ 集合框架      ├ Netty      ├ MongoDB     ├ 数据结构算法  ├ 简历
   ├ IO/NIO        ├ 分布式     │             │              │
   ├ 并发编程      ├ 消息队列   │             │              │
   ├ JVM           ├ 工具链     │             │              │
   └ 新特性        └ 开源轮子   └─────────────┴──────────────┘
...
| 专题 | 状态 | 专题 | 状态 |
|------|:----:|------|:----:|
| Java基础八股文 | ✅ 完成 | MySQL八股文 | ✅ 完成 |
| 集合框架八股文 | ✅ 完成 | Redis八股文 | ✅ 完成 |
| 并发编程八股文 | ✅ 完成 | Spring八股文 | ✅ 完成 |
| JVM八股文 | ✅ 完成 | 微服务八股文 | ✅ 完成 |
...
- [🔗 MySQL 学习路线](https://javabetter.cn/xuexiluxian/mysql.html)
- [🔗 Redis 学习路线](https://javabetter.cn/xuexiluxian/redis.html)
- [🔗 操作系统学习路线](https://javabetter.cn/xuexiluxian/os.html)

---

> **💡 使用建议**：建议按照 **Java基础 → Java进阶 → 数据库 → 求职面试** 的顺序学习。每一章都有详细笔记和代码示例，结合课堂所学效果更佳。面渣逆袭系列建议在面试前集中突击。
